const Checkbox = (props: {
  ...
  return (
    <input
      id={id}
      type="checkbox"
      className={`defaultCheckbox relative flex h-5 min-h-5 w-5 min-w-5 appearance-none items-center 
      justify-center rounded-md border border-gray-300 text-white/0 outline-none transition duration-200
